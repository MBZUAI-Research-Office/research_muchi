# Examples:
#  launch all shards:
#    python launch_moe_shards_ser.py --model-path ~/dbrx-instruct/distributable/batch1/
#
#  terminate all shards:
#    python launch_moe_shards_ser.py --model-path ~/dbrx-instruct/distributable/batch1/ --terminate
import subprocess
import time
