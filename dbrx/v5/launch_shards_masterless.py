# Examples:
#  launch all shards:
#    python launch_shards_masterless.py --model-path ~/dbrx-instruct/distributable/batch3/
#
#  terminate all shards:
#    python launch_shards_masterless.py --model-path ~/dbrx-instruct/distributable/batch3/ --terminate
import subprocess
import time
